...
@Tag(name="Auth")
@RestController
public class ControllersRestAuth {
	
    private static final Logger logger = LoggerFactory.getLogger(ControllersRestAuth.class);
    ...
    @Operation(summary = "Generate a token to access API", description = "")
    @RequestMapping(
    ...
    // Test api with token
    @Operation(summary = "Test token validity", description = "")
